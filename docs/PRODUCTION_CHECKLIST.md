...
- `MERCADO_PAGO_TEST_PAYER_USERNAME`: campo Usuario do comprador teste, apenas enquanto usar credencial `TEST-`.
- `MERCADO_PAGO_TEST_PAYER_EMAIL`: alternativa antiga ao username do comprador teste.
...
- Ao usar credenciais de teste, configure `MERCADO_PAGO_TEST_PAYER_USERNAME` com o campo Usuario de uma conta compradora teste.
